...
export declare const BookSchema: import("mongoose").Schema<Books, import("mongoose").Model<Books, any, any, any, import("mongoose").Document<unknown, any, Books> & Omit<Books & {
